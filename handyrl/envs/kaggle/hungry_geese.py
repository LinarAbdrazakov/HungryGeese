...
class Environment(BaseEnvironment):
    ...
    def __init__(self, args={}):
        super().__init__()
        self.env = make("hungry_geese") #.train([None, "Petya.py", "Serega.py", "Vasya.py"])
        self.reset()
    ...
    def step(self, actions):
        ...
        #observation = {}
        #observation["reward"] = obs[1]
        #observation["info"] = obs[3]
        #observation["observation"] = {
        #    "remainingOverageTime": obs[0]["remainingOverageTime"],
        #    "step": obs[0]["step"],
        #    "geese": obs[0]["geese"],
        #    "food": obs[0]["food"],
        #    "index": obs[0]["index"]
        #}
        #observation["status"] = "NOT ACTIVE" if obs[2] else "ACTIVE"
